...
const ProductCard = ({ product, setProducts }) => {
  ...
  return (
    <div className="card-body shadow rounded overflow-hidden transition-all hover:-translate-y-1 hover:shadow-lg">
      <img
        src={product.image}
        alt={product.name}
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          <button className="btn btn-ghost btn-xs text-success w-10 h-10">
            <Edit2Icon />
          </button>
          <button 
            type="button"
